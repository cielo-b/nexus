import { Award, Shield, Lightbulb, Users, Leaf, Heart,Target, Building2 } from "lucide-react"
...
const CoreValue: React.FC<CoreValueProps> = ({ icon: Icon, title, description }) => (
  <Fade>
    <div className="space-y-4 bg-white p-6 rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl">
...
export default function CoreValuesSection() {
  ...
  return (
    <section className="relative px-4 py-16 md:py-24 lg:py-32 bg-gray-50 overflow-hidden">
      {/* <img src="/images/zigs.svg" alt="zigs" className="absolute w-1/5 -bottom-1/3 -left-1/4 z-100" /> */}
