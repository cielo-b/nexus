  ...
  useEffect(() => {
    const fetchContent = async () => {
      ...
      try {
        ...
        const relatedCasesData = await fetchCases(articleData.service._id).then(
          (res) => {
            ...
            {article.image && (
              <div className="flex items-center justify-center">
                <img
                  src={article.image}
                  alt={article.title}
                  className=" h-auto max-h-[500px] w-fit rounded-lg mb-6 bg-neutral-50"
                />
              </div>
            )}
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 p-4">
                  ...
                  <p className="text-lg text-white/70 line-clamp-1">
                    <RichContent content={relatedCase.excerpt}></RichContent>
                  </p>
                </div>
              </Link>
            ))}
