        ...
        {career ? (
          <div className="flex-1">
            ...
            <div className="mt-5 flex justify-start">
              <a href={career.link} target="_blank" className={`bg-[#2563eb] text-white rounded-full flex gap-2 flex-row items-center justify-center max-sm:px-2 max-sm:py-2 px-10 py-2.5 hover:bg-[#2563eb11] border-[#2563eb] hover:shadow-sm hover:shadow-[#2563eb45] ease-out duration-300 group border w-fit`}>Apply Now</a>
            </div>
          </div>
        ) : (
          <div className="text-center text-gray-600 text-lg">No career found.</div>
        )}
      </div>
      <Footer />
