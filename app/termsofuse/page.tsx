...
const privacyPolicySections = [
  {
    ...
    content: (
      <div>
        <p>
          Welcome to Nexus, operated by Nexus LTD. These Terms of Use govern
          your use of our mobile application ("Nexus") and web application. By
  ...
  },
  {
    ...
    content: (
      <div>
        <p>
          <strong>"Nexus," "we," "our," "us":</strong> Refers to Nexus LTD and
          its services.
        </p>
        <p>
        ...
        <p>
          ...
          application, and any other related services provided by Nexus LTD.
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        <p>
          To use Nexus, you must be at least 10 years old. By using our
    ...
    content: (
      <div>
        <p>
          ...
          Nexus, you may be required to create an account. You agree to provide
  ...
  },
  {
    ...
    content: (
      <div>
        <p>
          <strong>License:</strong> Nexus grants you a limited, non-exclusive,
    ...
    content: (
      <div>
        <p>
          ...
          icons, and software, are the exclusive property of Nexus LTD and are
  ...
  },
  {
    ...
    content: (
      <div>
        <p>
          Nexus may contain links to third-party websites or services that are
          not owned or controlled by Nexus LTD. We have no control over and
          assume no responsibility for, the content, privacy policies, or
          practices of any third-party websites or services. You acknowledge and
          agree that Nexus LTD shall not be responsible or liable, directly or
    ...
    content: (
      <div>
        <p>
          ...
          implied. Nexus LTD does not warrant that the services will be
        ...
        <p>
          ...
          permitted by applicable law, Nexus LTD shall not be liable for any
  ...
  },
  {
    ...
    content: (
      <div>
        <p>
          You agree to defend, indemnify, and hold harmless Nexus LTD, its
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <p>
          Email: <a href="mailto:team.nexus@gmail.com">team.nexus@gmail.com</a>
        </p>
        <p>
          Phone: <a href="tel:+250782988053">+250782988053</a>
        </p>
      </div>
    ),
  },
