    ...
    <div className="min-h-screen  flex items-center justify-center">
      <div className="text-center">
        ...
        <div className="space-x-4">
          <Link
            href="/publications"
            className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6  transition-colors"
          >
            View All Publications
          </Link>
          <Link
            href="/"
            className="inline-block bg-gray-600 hover:bg-gray-700 text-white font-semibold py-3 px-6  transition-colors"
          >
            Go Home
          </Link>
        </div>
